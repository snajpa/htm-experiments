...
__device__ void randomSample(struct CellType** cells, int n, struct CellType** ssCells, int m);
__device__ void initSegmentUpdateInfo(SegmentUpdateInfo* info, struct CellType* cell,
